        ...
        <div class="container-fluid col-12">
            <div class="row">
                ...
                <div class="col-3 option-card">
                    <div class="card" style="width: 18rem;" class="option-card">
                        <div class="card-body">
                            <h5 class="card-title">Service Review</h5>
                            <p class="card-text">Lorem ipsum dolor sit amet consectetur adipisicing elit.
                                Laudantium rem corporis aspernatur porro magni.</p>
                            <div class="col-12 text-center">
                                <a href="{{route('newfeedback')}}" class="btn btn-danger">Write a review</a>
                            </div>
                        </div>
                    </div>
                </div>
        ...
        @if (count($commands)>=1)
            <table class="table h-auto col-lg-12">
                ...
                <tbody>
                    ...
                    <tr>
                        <th scope="row" class="w-auto">{{$command->id_command}}</th>
                        ...
                        <form action="{{route('printpdf',[$command->id])}}" method="get">
                                @csrf
                                @method('GET')
                        ...
                        <form action="{{route('deleteorder',[$command->id])}}" method="delete">
                                ...
                                @else
                                <button disabled type="submit" class='btn btn-success' >Withdraw</button>
                                @endif
                            </form>
